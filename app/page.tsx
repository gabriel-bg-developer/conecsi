...
export default function Home() {
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-[#5e2750] text-white py-2 px-4">
        <div className="container mx-auto">
          <p className="text-sm font-medium">En Conecsi priorizamos el escuchar, entender y atender a nuestros clientes.</p>
        </div>
      </div>
      ...
      <header className="bg-white py-4 px-4 md:px-8 border-b border-gray-100 sticky top-0 z-50">
        <div className="container mx-auto flex items-center justify-between">
          ...
          >
            <Link
              href="#"
              className="block md:inline-block text-gray-700 hover:text-[#5e2750] transition-colors py-2 md:py-0"
            >
              Inicio
            </Link>
            <Link
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              className="md:hidden p-2 rounded-full bg-gray-100 hover:bg-[#e5e7eb] transition-colors"
          ...
          <div className="container mx-auto relative z-10 px-4">
            <div className="max-w-3xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-[#00b8a9] text-white px-8 py-4 rounded-full text-lg font-medium shadow-lg hover:bg-[#009b8f] transition-colors">
                  Encuentra el Mejor Talento
                </button>
              </div>
            </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-xl shadow-sm hover:shadow-md transition-all p-6 border border-gray-100 hover:border-[#5e2750]/20">
                ...
                <Link href="#" className="inline-flex items-center text-[#5e2750] font-medium hover:bg-[#4e2042] hover:shadow-md transition-colors">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all border border-gray-100 hover:border-[#5e2750]/20 text-center group">
                <div className="bg-[#5e2750]/10 rounded-full h-20 w-20 flex items-center justify-center mx-auto mb-6 group-hover:bg-[#5e2750]/10 hover:shadow-md transition-colors">
              ...
              {/* Reason 2 */}
              <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all border border-gray-100 hover:border-[#5e2750]/20 text-center group">
                <div className="bg-[#00b8a9]/10 rounded-full h-20 w-20 flex items-center justify-center mx-auto mb-6 group-hover:bg-[#00b8a9]/10 hover:shadow-md transition-colors">
            ...
            <div className="flex justify-center mt-12">
              <button className="bg-gradient-to-r from-[#5e2750] to-[#4e2042] text-white px-8 py-4 rounded-full text-lg font-medium shadow-lg hover:from-[#4e2042] hover:to-[#3e1934] transition-colors">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all border border-gray-100 hover:border-[#5e2750]/20">
                <div className="flex flex-col md:flex-row">
                  <div className="md:w-2/5 relative">
                    <div className="absolute inset-0 bg-[url('/images/developer.jpg')] bg-cover bg-center"></div>
                    <div className="relative md:hidden aspect-video"></div>
                    <div className="hidden md:block relative h-full"></div>
                  </div>
                  <div className="md:w-3/5 p-6 md:p-8">
            ...
            <div className="flex justify-between items-center">
              <Link href="#" className="text-[#5e2750] font-medium hover:bg-[#4e2042] hover:shadow-md transition-colors flex items-center">
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-white text-[#00b8a9] px-8 py-4 rounded-full text-lg font-medium shadow-lg hover:bg-[#f0f0f0] transition-colors">
                  Encuentra el Mejor Talento
                </button>
                <button className="bg-[#5e2750] text-white px-8 py-4 rounded-full text-lg font-medium shadow-lg hover:bg-[#4e2042] transition-colors">
                  Postula tu CV
                </button>
              </div>
            </div>
  ...
  <ul className="space-y-3">
    <li>
      <Link href="#" className="text-gray-300 hover:text-[#ffffff] hover:font-semibold transition-colors">
        FAQ
      </Link>
    </li>
    <li>
          ...
          <div className="border-t border-[#3e1934] pt-4 mt-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6">
                <Link href="#" className="text-gray-300 hover:bg-gray-200 hover:shadow-md transition-colors">
